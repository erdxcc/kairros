...
// Static shapes for the mock UI below. Named rather than index-keyed so React
// has a stable identity for each bar and segment.
const PERIOD_SEGMENTS = ['d1', 'd2', 'd3', 'd4', 'd5', 'd6', 'd7', 'd8'] as const;
const REVENUE_BARS = [5, 8, 6, 9, 7, 11, 9, 13].map((height, i) => ({
    id: `bar-${i}`,
    height,
}));
