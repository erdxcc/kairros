...
export const audienceSection = {
    ...
    subheading: 'One layer, three jobs: people stay in control, businesses get paid, developers ship fast.',
} as const;
...
export const ecosystem = {
    ...
    marks: ['Helio', 'Solpay', 'Orbiton', 'Driftwood', 'Pendari', 'Nova Rail', 'Quorum', 'Lumen'],
} as const;
    ...
    columns: [
        {
            heading: 'Personal',
            links: [
                { label: 'Manage subscriptions', href: site.dashboardUrl },
        ...
        },
        {
            heading: 'Business',
            links: [
                { label: 'Accept payments', href: site.dashboardUrl },
                { label: 'Reconciliation', href: site.dashboardUrl },
                { label: 'Pricing', href: '#pricing' },
                { label: 'Status' },
            ],
        },
        ...
        {
            heading: 'Company',
            links: [{ label: 'About' }, { label: 'Blog' }, { label: 'Careers' }, { label: 'Brand' }],
        },
        {
            heading: 'Legal',
